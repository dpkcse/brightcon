...
class DatabaseSeeder extends Seeder
{
    public function run(): void
    {
        ...
        foreach ([
            ...
            ['section_key' => 'partner_messages', 'title' => 'Messages from Our Partners', 'subtitle' => 'Leadership insights, shared values, and the vision behind our journey.', 'sort_order' => 2],
