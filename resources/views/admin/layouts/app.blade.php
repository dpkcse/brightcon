...
<div class="admin-shell d-flex">
    ...
    @php($groups = [
        ...
        'Content' => [['Custom Pages', route('admin.pages.index'), 'admin.pages.*'], ['Equipment', route('admin.equipment.index'), 'admin.equipment.*'], ['Competencies', route('admin.competencies.index'), 'admin.competencies.*'], ['Project Categories', route('admin.project-categories.index'), 'admin.project-categories.*'], ['Projects', route('admin.projects.index'), 'admin.projects.*'], ['Services', route('admin.services.index'), 'admin.services.*'], ['Organizations', route('admin.organizations.index'), 'admin.organizations.*'], ['Gallery Images', route('admin.gallery-images.index'), 'admin.gallery-images.*'], ['Partner Messages', route('admin.partner-messages.index'), 'admin.partner-messages.*'], ['Contact Messages', route('admin.contact-messages.index'), 'admin.contact-messages.*', $unreadMessages]],
