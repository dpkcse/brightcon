...
<section class="home-organizations section-spacing" aria-labelledby="organizations-title">
    <div class="container-xl">
        ...
        <div class="organization-grid mt-4">
            @foreach($organizations as $organization)
                ...
                <div class="organization-item">
                    ...
                    @if($logoUrl)<img src="{{ $logoUrl }}" alt="{{ $organization->name }} logo" loading="lazy" decoding="async">@else<span>{{ $organization->name }}</span>@endif
