...
<section class="container section-spacing">
    ...
    @if($services->count())
        <div class="row g-4">@foreach($services as $service)<div class="col-md-6 col-xl-4">@include('frontend.partials.content.service-card', ['service' => $service])</div>@endforeach</div>
