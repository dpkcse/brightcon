...
<section class="container section-spacing">
    ...
    @if($projects->count())<div class="row g-4">@foreach($projects as $project)<div class="col-md-6 col-xl-4">@include('frontend.partials.content.project-card', ['project' => $project])</div>@endforeach</div><div class="mt-5">{{ $projects->links() }}</div>@else @include('frontend.partials.content.empty-state', ['title' => 'No projects found', 'message' => 'Active projects added from the CMS will appear here.']) @endif
</section>
@endsection
