...
Standard support is not included with the Single Site License. Included materials are the product files, installation/administrator/configuration documentation, changelog, published security notices, and access to published updates under the update policy.

Personal installation, hosting administration, domain/DNS/SMTP configuration, custom development, content entry, redesign, migration, extensive debugging of buyer changes, third-party API/hosting support, emergency support, and guaranteed response times are excluded.
